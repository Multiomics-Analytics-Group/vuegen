...
file_path = (section_dir / '../../example_data/Basic_example_vuegen_demo_notebook/4_Html/1_All_html/1_plot.html').resolve().as_posix()
...
file_path = (section_dir / '../../example_data/Basic_example_vuegen_demo_notebook/4_Html/1_All_html/2_ckg_network.html').resolve().as_posix()
...
file_path = (section_dir / '../../example_data/Basic_example_vuegen_demo_notebook/4_Html/1_All_html/3_multiqc_report.html').resolve().as_posix()
with open(file_path, 'r', encoding='utf-8') as f:
    html_content = f.read()

...
file_path = (section_dir / '../../example_data/Earth_microbiome_vuegen_demo_notebook/3_Network_analysis/1_phyla_association_networks/1_phyla_counts_subset.csv').resolve().as_posix()
...
file_path = (section_dir / '../static/Phyla_Correlation_Network_With_0.5_Threshold_Edgelist.html').resolve().as_posix()
...
st.markdown(("<p style='text-align: center; color: black;'> "
            ...
            unsafe_allow_html=True)
st.markdown(("<p style='text-align: center; color: black;'>"
             " <b>Number of relationships:</b> 42"
             " </p>"),
            unsafe_allow_html=True)

...
file_path = (section_dir / '../../example_data/Earth_microbiome_vuegen_demo_notebook/2_Metagenomics/3_nestedness/1_nestedness_random_subset.csv').resolve().as_posix()
...
file_path = (section_dir / '../../example_data/Earth_microbiome_vuegen_demo_notebook/2_Metagenomics/3_nestedness/2_all_samples.json').resolve().as_posix()
...
file_path = (section_dir / '../../example_data/Earth_microbiome_vuegen_demo_notebook/2_Metagenomics/3_nestedness/3_plant_samples.json').resolve().as_posix()
with open(file_path, 'r') as plot_file:
    plot_json = json.load(plot_file)
...
plot_file_path = (section_dir / '../../example_data/Earth_microbiome_vuegen_demo_notebook/2_Metagenomics/3_nestedness/4_animal_samples.png').resolve().as_posix()
...
plot_file_path = (section_dir / '../../example_data/Earth_microbiome_vuegen_demo_notebook/2_Metagenomics/3_nestedness/5_non_saline_samples.png').resolve().as_posix()
st.image(plot_file_path, caption='', use_column_width=True)

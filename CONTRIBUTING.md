...
A new PR is submitted to the [bioconda-recipes][bioconda-recipes] repository
when a new release is created. The PR is automatically generated by the bioconda tooling
and eventually merged. Example:
...
1. Build new containers: https://seqera.io/containers
